...
<aside class="main-sidebar sidebar-light-lightblue elevation-4">
    ...
    <a href="" class="brand-link">
        ...
        <span class="brand-text font-weight-bold">SEBIDUK Linggau</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('template/landingPage/assets/img/default.jpg') }}" class="img-circle elevation-2"
                    alt="User Image">
            </div>
            <div class="info">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ url('/EntryUMKM') }}" class="nav-link {{ Request::is('EntryUMKM*') ? 'active' : '' }}">
